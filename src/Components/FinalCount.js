...
const FinalCount = ({p1,p2}) => {
  ...
  const gameOver = () =>{
    ...
    return ( 
        ...
        <input  type="number" min="1" max='99' keyboardType="number-pad" pattern="\d*" className="text-black my-6 outline-none py-3 text-4xl text-center" maxLength={2} value={newScore} onChange={(e)=> updateScore(e)} onKeyUp={e => { if(e.key === 'Enter'){
